...
export default function About() {
    return (
        <Container maxWidth="md" style={{ backgroundColor: '#f0f0f0', padding: '20px', borderRadius: '8px' }}>
            <Typography variant="h2" gutterBottom style={{ fontFamily: 'Arial', borderBottom: '2px solid #000', marginBottom: '20px' }}>About BoardState</Typography>
            <Box sx={{ bgcolor: 'background.paper', p: 3, borderRadius: 4, border: '2px solid #000' }}>
                <Typography variant="body1" style={{ fontFamily: 'Arial', fontSize: '1.2rem' }}>
                ...
                <Typography variant="body1" mt={2} style={{ fontFamily: 'Arial', fontSize: '1.2rem' }}>
                    Features:
                    <ul>
